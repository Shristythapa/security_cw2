...
const VideoCall = () => {
  ...
  // const state = "65cfdce6d75dfcf6bd349ec5";
  // const { state } = state || {};
  ...
  useEffect(() => {
      ...
      .then((stream) => {
        ...
        peer.on("call", (call) => {
          ...
          call.on("stream", (userVideoStream) => {
            addVideoStream(video, userVideoStream, user._id);
           
          });
        });

        //send mentor joined notification
    ...
    //function to handle connected user streem
